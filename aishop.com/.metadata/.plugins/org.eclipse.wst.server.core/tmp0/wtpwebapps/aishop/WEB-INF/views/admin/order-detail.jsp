                ...
                <ul class="d-flex flex-col align-items-center p-m-none">
                    ...
                    <li class="nav-item w-100 my-6-0">
                        <div id="show-option-product" class="cursor-pointer show-option nav-item--link d-flex align-items-center justify-content-around">
                            ...
                            <svg id="arrow-ronate-product" width='1rem' height='1rem' viewBox='0 0 24 24' fill='%2371869d'>
                                <path style="fill:#8799ac; stroke-width: 6px" d='M12.72,15.78a.75.75,0,0,1-.53.22h-.38a.77.77,0,0,1-.53-.22L6.15,10.64a.5.5,0,0,1,0-.71l.71-.71a.49.49,0,0,1,.7,0L12,13.67l4.44-4.45a.5.5,0,0,1,.71,0l.7.71a.5.5,0,0,1,0,.71Z'/>
                            </svg>
                        </div>
                        <ul id="product-option" style="display: none;">
                            <li>
                    ...
                    <li class="nav-item w-100 my-6-0">
                        <div id="show-option-order" class="cursor-pointer show-option nav-item--link d-flex align-items-center justify-content-around">
                            ...
                            <svg id="arrow-ronate-order" style="transform: scaleY(-1);" width='1rem' height='1rem' viewBox='0 0 24 24' fill='%2371869d'>
                                <path style="fill:#8799ac; stroke-width: 6px" d='M12.72,15.78a.75.75,0,0,1-.53.22h-.38a.77.77,0,0,1-.53-.22L6.15,10.64a.5.5,0,0,1,0-.71l.71-.71a.49.49,0,0,1,.7,0L12,13.67l4.44-4.45a.5.5,0,0,1,.71,0l.7.71a.5.5,0,0,1,0,.71Z'/>
                            </svg>
                        </div>
                        <ul id="order-option" style="display: block;">
                            <li>
                                <a class="nav-item--link d-flex align-items-center justify-content-around" style="padding-right: 1.75rem; background: aliceblue; padding-left: 3.25rem;" href="/aishop/manager-orders.htm">
                                    <svg height=".4rem" width=".4rem" viewBox="0 0 512 512">
                                        <path style="fill:#8799ac; stroke-width: 6px" d="M464 256A208 208 0 1 0 48 256a208 208 0 1 0 416 0zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256z"/>
                                    </svg>
                ...
                <div class="product-cont">
		            <div class="content__header">
		            	<div class="header__breadcrumb">
			                <p class="breadcrumb__root">Orders /</p>
			                <p class="breadcrumb__leaf text-dark">Order Detail</p>
			            </div>
				            <h1 class="header__heading text-dark">Orders</h1>
			        </div>
			    </div>
                <div class="product-cont1">
                    <a href=""><i class="fa-solid fa-download"></i>
                        Export</a>
                    <a  href=""><i class="fa-solid fa-upload"></i>
                        Import</a>
                </div>
            </div>
            <div class="product-btn">
                <a href="/aishop/product-detail.htm"><button>Confirm</button></a>
            </div>
        </div>

        <div class="product-body">
            <p class="underline">All orders</p>
                    ...
                    <table class="styled-table">
                        <thead>
                            <tr>
                                <th>ID ORDER</th>
                                <th>DATE</th>
                                <th><i class="fa-solid fa-phone" style="font-size: 13px;"></i>  CONTACT</th>
                                <th>ORDER STATUS</th>
                                ...
                                <td>
                                    <div class="group">
                                        <a class="group-child" href=""><i class="fa-solid fa-pen-to-square"></i>
                                            Edit</a>
                                        <a class="group-child" href=""><i class="fa-solid fa-trash"></i>
                                            Remove</a>
                                    </div>
                                </td>
                            </tr>
