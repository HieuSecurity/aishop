...
<head>
    ...
    <link rel="stylesheet" href="/aishop/resources/assets/css/profile-user.css">
...
<body>
	<header id="header">
            <!-- Start Navbar Top -->
        <nav id="aishop-top" class="navbar text_line bg-dark" style="padding: 8px;">
        ...
        <!-- Start Navbar Header -->
        <nav id="aishop-header" class="navbar navbar-expand shadow" style="padding: .3rem 0">
	...
	<main class="main-content" style="padding-bottom: 35px;">
        <!-- Header -->
        <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 600px; background-image: url(https://raw.githubusercontent.com/creativetimofficial/argon-dashboard/gh-pages/assets-old/img/theme/profile-cover.jpg); background-size: cover; background-position: center top;">
          ...
          <!-- Header container -->
          <div class="container-fluid d-flex align-items-center" style="padding-left: 135px !important;">
             <div class="row d-flex justify-content-between">
              <div class="col-lg-7 col-md-10">
                <h1 class="display-2 text-white">Hello Dong</h1>
                    ...
                    <div class="col">
                      <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                        <div>
                          ...
                          <span class="description">Carts</span>
                        </div>
                        <div>
