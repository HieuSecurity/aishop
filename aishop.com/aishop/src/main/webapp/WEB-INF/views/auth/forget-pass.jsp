	        ...
	        <div class="login--input">
	            <div id="login__style--input">
	                <div id="logo">
	                    ...
	                    <span>Xác thực tài khoản email</span>
	                </div>
	                <div class="frame--input">
	                    <form method="POST">
	                        ...
	                        <span class ="error_login" style="display: block">Email chưa được đăng ký!</span>
	                        <button id="btn_sigup" class="btn--sigup" style="margin-top: 13px;" name="pass--get">Confirm</button>
