            ...
            <div class="login--input">
                <div id="login__style--input">
                    ...
                    <div class="frame--input">
                        <form action="sign-in.htm" method="POST">
                            <input class="email username" name="email" style="margin-bottom: 5px; border-color: rgb(221, 223, 226)" placeholder="Email address" type="text" required pattern="\S+@(\S+\.\S+)+" />
                            ...
                            <button id="btn_sigup" class="btn--sigup" style="margin-top: 13px;" name="click--sigup">Login</button>
                        ...
                        <a href="/aishop/sign-up.htm">
                            <button class="btn--login" style="background-color: chartreuse;">Create Account</button>
                        </a>
                    </div>
                </div>
            </div>
