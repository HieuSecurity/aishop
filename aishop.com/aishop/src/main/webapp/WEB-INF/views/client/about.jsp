...
<body>
    ...
    <main id="aishop-about">
        <section class="bannerabout">
            <nav class="container d-flex align-items-center" style="height: 100%;">
                <div class="box-about">
                    <h3>GIỚI THIỆU VỀ CHÚNG TÔI</h3>
                    <p style="font-size: 17px; margin-top: 7px;">
                        Tạo dựng website bán hàng mỹ phẩm uy tín chất lượng, và có tính bảo mật cao về web và cơ sở dữ
                        liệu, tiện dụng và an toàn đến người sử dụng thông tin. Cảm ơn mọi người đã tin dùng và lựa chọn
                        Website của chúng tôi là môi trường để mua sắm các sản phẩm tiêu dùng phù hợp.
                    </p>
                </div>
                <img src="/aishop/resources/assets/img/aishop_default/bannerabout.png" alt="banner">
            </nav>
        </section>
        <section class="wrapper ">
            <nav class=container >
                <nav class="textwapper" style="text-align: center;">
                    <b>Our Services</b>
                    <span class="note">Các dịch vụ tiện ích khác.</span>
                </nav>
                
                <div class="card d-flex justify-content-between">
                    <div class="rectangle d-flex shadow">
                        <nav>
                            <i class="fa-solid fa-truck-fast"></i>
                            <span class="text-rectangle" style="font-weight: 500; line-height: 1.2; font-size: 1.2rem;">Vận chuyển</span>
                        </nav>
                    </div>
                    <div class="rectangle d-flex shadow">
                        <nav>
                            <i class="fa-solid fa-arrow-right-arrow-left"></i>
                            <span class="text-rectangle">Thanh toán</span>
                        </nav>
                    </div>
                    <div class="rectangle d-flex shadow">
                        <nav>
                            <i class="fa-solid fa-percent"></i>
                            <span class="text-rectangle">Sale</span>
                        </nav>
                    </div>
                    <div class="rectangle d-flex shadow">
                        <nav>
                            <i class="fa-solid fa-user"></i>
                            <span class="text-rectangle">Chăm sóc khách hàng</span>
                        </nav>
                    </div>
                </div>
            </nav>
        ...
        <section class="imageslider" style="padding: 3rem; background-color: #eeeeee; padding-left: 269px; padding-right: 200px;">
            <div class="img-item first" style="width: none;">
                <img class="img-size" src="/aishop/resources/assets/img/brand/Bbia.jpg" alt="">
            </div>
            <div class="img-item">
                <img class="img-size" src="/aishop/resources/assets/img/brand/Catrice.png" alt="">
            </div>
            <div class="img-item">
                <img class="img-size" src="/aishop/resources/assets/img/brand/LOreal Paris.png" alt="">
            </div>
            <div class="img-item">                           
                <img class="img-size" src="/aishop/resources/assets/img/brand/Maybelline New York.png" alt="">
            </div>
            <div class="img-item">
                <img class="img-size" src="/aishop/resources/assets/img/brand/OIP.jpg" alt=""></div>
            <div class="img-item">
                <img class="img-size" src="/aishop/resources/assets/img/brand/OIP (1).jpg" alt="">
            </div>
        </section>
