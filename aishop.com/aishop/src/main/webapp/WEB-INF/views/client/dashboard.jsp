                ...
                <ul class="d-flex flex-col align-items-center p-m-none">
                    <li class="nav-item w-100 my-6-0">
                        <div id="show-option-dashboard" class="cursor-pointer nav-item--link d-flex align-items-center justify-content-around" href="#">
                            ...
                            <svg id="arrow-ronate-dashboard" style="transform: scaleY(-1);" width='1rem' height='1rem' viewBox='0 0 24 24' fill='%2371869d'>
                        ...
                        <ul id="dashboard-option" style="display: block;">
                            <li>
                                <a class="nav-item--link d-flex align-items-center justify-content-around" style="padding-right: 1.75rem; background: aliceblue; padding-left: 3.25rem;" href="/aishop/dashboard.htm">
                            ...
                            <div id="account" class="account-block dropped-down-block p-absolute">
                                <ul class="d-flex flex-col p-m-none">
                                    ...
                                    <li class="account-option option-link">
                                        <a class="py-5 option-hover text-dark" style="padding-left: 16px !important;padding-right: 134px !important;" href="/aishop/profile-user.htm
                                        ">
                                            Profile & account
                                        </a>
                                    </li>
                                    ...
                                    <li class="account-option option-link navbar-setting" style="padding: 12px 0 0 0 !important; margin: 0;">
                                        <a class="py-5 option-hover text-dark" style="padding-left: 16px !important;padding-right: 188px !important;" href="/aishop/logout.htm">
                                            Sign out
                                        </a>
                                    </li>
                                </ul>
