...
<head>
	...
	<link rel="stylesheet" href="/aishop/resources/assets/css/style.css">
...
<body>
    ...
    <div class="p-relative">
        <!-- Nếu đã đăng nhập, hiển thị "Xin chào" -->
        <c:if test="${not empty sessionScope.user}">
            <a href="#" class="text-light" style="font-size: 14px !important;">
                Xin chào, ${sessionScope.user.email}
            </a>
        </c:if>
  ...
  <div class="user-menu">
   <a href="#" class="nav-icon">
    ...
    <main id="aishop-home">
        ...
        <section class="image-slider" style="padding: 3rem; background-color: #eeeeee;">
            <div class="image-item" style="width: 1397px !important;">
                <div class="item-content">
                    <div class="text">
                        <h3 class="image-title">Matte Lipstick BBIA Last Velvet Tip Tint Version 5 Official Store</h3>
                        <h2>BBIA</h2>
                        <p>Bbia Last Velvet Lip Tint is a matte lipstick with extremely high adhesion, attracts to your lips like a magnet and gives clear color after just one application.</p>    
                    
                    </div>
                    <div class="image">
                        <img src="/aishop/resources/assets/img/pro-img/Picture1.png" alt="">
                    </div>  
                </div>   
            </div>
            <div class="image-item" style="width: 1397px !important;">
                <div class="item-content">
                    ...
                    <div class="image">
                        <img src="/aishop/resources/assets/img/pro-img/Picture10.png" alt="">
                    </div>  
                </div>
        ...
        <section class="content-2">
            ...
            <p class="style-p">Some best-selling products are of interest in the market</p>
            <div class="content-child-2">
                <div class="block-child-2">
                    <div style=" padding: 2rem; padding-bottom: 0; height: 334px;">
                        <a href="">
                            <img src="/aishop/resources/assets/img/pro-img/Picture10.png" alt="">
                        </a>
                    </div>
                    <div class="block">
                        <h5>Matte Lipstick BBIA Last Velvet Tip Tint Version 5 Official Store</h5>
                        <span class="text_limit">Bbia Last Velvet Lip Tint is a matte lipstick with extremely high adhesion, attracts to your lips like a magnet and gives clear color after just one application.</span>
                        <p >Review (152)</p>
                    </div> 
                </div>
                ...
                <div class="block-child-2">
                    <div style=" padding: 2rem; padding-bottom: 0; height: 334px;">
                        <a href="">
                            <img src="/aishop/resources/assets/img/pro-img/Picture12.png" alt="">
                        </a>
                    </div>
                    <div class="block">
                        <h5>Matte Lipstick BBIA Last Velvet Tip Tint Version 5 Official Store</h5>
